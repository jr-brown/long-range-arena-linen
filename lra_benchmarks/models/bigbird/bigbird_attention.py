...
from lra_benchmarks.utils.array_utils import pad_inputs, make_attention_mask
...
def band_start_block_rand_multi_attention_pad(query_matrix, key_matrix, value_matrix, rand_attn,
                                              band_pad, rand_pad, seq_m_pad, seq_n_pad, b, h, m,
                                              wm, n, wn, r, d):
...
def sparse_dot_product_attention(queries, keys, values, connectivity_seed, input_mask=None,
                                 block_size=64, num_rand_blocks=3):
    ...
    queries = jnp.pad(queries, ((0, 0), (0, seq_length - from_seq_length), (0, 0), (0, 0)))
    keys = jnp.pad(keys, ((0, 0), (0, seq_length - to_seq_length), (0, 0), (0, 0)))
    values = jnp.pad(values, ((0, 0), (0, seq_length - to_seq_length), (0, 0), (0, 0)))
    ...
    # create band padding
    band_pad = create_band_mask_from_inputs(blocked_input_mask, blocked_input_mask)
    rand_pad = create_rand_mask_from_inputs(blocked_input_mask, blocked_input_mask, rand_attn)
