...
def get_dataset(batch_size, data_dir, task_name):
    """Get dataset from matching datasets converts into src/tgt pairs."""
    train_fps = data_dir + task_name + '_train.tsv'
    valid_fps = data_dir + task_name + '_eval.tsv'
    test_fps = data_dir + task_name + '_test.tsv'
...
def get_matching_datasets(n_devices,
    ...
    train_dataset, val_dataset, test_dataset = get_dataset(batch_size, data_dir, task_name)
